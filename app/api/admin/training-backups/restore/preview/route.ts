...
import { previewTrainingBackupRestore, TrainingBackupError } from '@/lib/training-backup'
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(await previewTrainingBackupRestore(snapshotId))
  } catch (error) {
    return buildBackupErrorResponse(error, 'Failed to preview training backup restore.')
  }
}
